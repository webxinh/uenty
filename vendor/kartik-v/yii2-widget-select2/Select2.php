   ...
   /**
    ...
    protected function renderToggleAll()
    {
        ...
        $settings = array_replace_recursive([
            'selectLabel' => '<i class="glyphicon glyphicon-unchecked"></i>' . Aabc::t('kvselect', 'Select all'),
            'unselectLabel' => '<i class="glyphicon glyphicon-check"></i>' . Aabc::t('kvselect', 'Unselect all'),
            'selectOptions' => [],
            'unselectOptions' => [],
