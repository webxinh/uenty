...
namespace aabc\debug\controllers;

use Aabc;
use aabc\web\Controller;
use aabc\web\NotFoundHttpException;
use aabc\debug\models\search\Debug;
...
class DefaultController extends Controller
{
    ...
    {
        Aabc::$app->response->format = Response::FORMAT_HTML;
    ...
    public function loadData($tag, $maxRetry = 0)
    {
        ...
        // See: https://github.com/aabcsoft/aabc2/issues/1504
