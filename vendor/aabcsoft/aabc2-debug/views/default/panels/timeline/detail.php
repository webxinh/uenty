<?php
/* @var $panel aabc\debug\panels\TimelinePanel */
/* @var $searchModel \aabc\debug\models\search\Timeline */
/* @var $dataProvider \aabc\debug\components\TimelineDataProvider */

use aabc\helpers\Html;
use aabc\widgets\ActiveForm;
use aabc\widgets\Pjax;
use aabc\debug\TimelineAsset;
    ...
    <div class="debug-timeline-panel__items">
        ...
        <?php if (($models = $dataProvider->models) === []): ?>
            <div class="debug-timeline-panel__item empty">
                <span><?= Aabc::t('aabc', 'No results found.'); ?></span>
            </div>
        <?php else: ?>
