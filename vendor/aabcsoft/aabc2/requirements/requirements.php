...
/* @var $this AabcRequirementChecker */
return array(
    array(
        'name' => 'PHP version',
        'mandatory' => true,
        'condition' => version_compare(PHP_VERSION, '5.4.0', '>='),
        'by' => '<a href="http://www.aabcframework.com">Aabc Framework</a>',
    ...
    array(
        ...
        'by' => '<a href="http://www.aabcframework.com/doc-2.0/aabc-base-security.html">Security Component</a>',
    ...
    array(
        ...
        in <code>Aabc::t()</code>, non-latin languages with <code>Inflector::slug()</code>,
        <abbr title="Internationalized domain names">IDN</abbr>-feature of
        <code>EmailValidator</code> or <code>UrlValidator</code> or the <code>aabc\i18n\Formatter</code> class.'
    ),
    array(
        'name' => 'ICU version',
        'mandatory' => false,
        ...
        <a href=\"http://www.aabcframework.com/doc-2.0/aabc-i18n-formatter.html#asRelativeTime%28%29-detail\">
        Formatter::asRelativeTime()</a>) in the <code>aabc\i18n\Formatter</code> class. Your current ICU version is ' .
    ...
    array(
        ...
        (for example, plural in
        <a href=\"http://www.aabcframework.com/doc-2.0/aabc-i18n-formatter.html#asRelativeTime%28%29-detail\">
        Formatter::asRelativeTime()</a>) in the <code>aabc\i18n\Formatter</code> class. Your current ICU Data version is ' .
    ...
    array(
        ...
        'memo' => 'Required for REST API to send XML responses via <code>aabc\web\XmlResponseFormatter</code>.'
    ),
);
