...
<head>
    <meta charset="utf-8"/>
    <title>Aabc Application Requirement Checker</title>
    <?php $this->renderViewFile(dirname(__FILE__) . '/css.php'); ?>
</head>
<body>
<div class="container">
    <header>
        <h1>Aabc Application Requirement Checker</h1>
    </header>
    <hr>
    <main>
        <h3>Description</h3>
        ...
        to allow Aabc to work as expected. There are also some optional requirements being checked which will
        show you a warning when they do not meet. You can use Aabc framework without them but some specific
    ...
    <footer>
        ...
        <p>Powered by <a href="http://www.aabcframework.com/" rel="external">Aabc Framework</a></p>
    </footer>
</div>
</body>
</html>
