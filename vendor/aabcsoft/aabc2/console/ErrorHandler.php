...
class ErrorHandler extends \aabc\base\ErrorHandler
{
    ...
    protected function renderException($exception)
    {
        if ($exception instanceof UnknownCommandException) {
        ...
        } elseif ($exception instanceof Exception && ($exception instanceof UserException || !AABC_DEBUG)) {
            ...
            if ($exception instanceof \aabc\db\Exception && !empty($exception->errorInfo)) {
    ...
    protected function formatMessage($message, $format = [Console::FG_RED, Console::BOLD])
    {
        ...
        if (Aabc::$app->controller instanceof \aabc\console\Controller && Aabc::$app->controller->isColorEnabled($stream)
            || Aabc::$app instanceof \aabc\console\Application && Console::streamSupportsAnsiColors($stream)) {
