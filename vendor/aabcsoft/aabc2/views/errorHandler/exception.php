...
/* @var $handler \aabc\web\ErrorHandler */
?>
...
<head>
    ...
    <title><?php
        ...
        if ($exception instanceof \aabc\web\HttpException) {
...
<body>
    <div class="header">
        ...
        <?php if ($exception instanceof \aabc\db\Exception && !empty($exception->errorInfo)) {
...
window.onload = function() {
    ...
    <?php if (method_exists($this, 'endBody')) $this->endBody(); // to allow injecting code into body (mostly by Aabc Debug Toolbar) ?>
</body>
