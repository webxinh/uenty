...
class BaseFileHelper
{
    ...
    public static $mimeMagicFile = '@aabc/helpers/mimeTypes.php';
    ...
    {
        if ($magicFile !== null) {
            $magicFile = Aabc::getAlias($magicFile);
        }
    ...
    public static function createDirectory($path, $mode = 0775, $recursive = true)
    {
        ...
        try {
            ...
            if (!is_dir($path)) {// https://github.com/aabcsoft/aabc2/issues/9288
                throw new \aabc\base\Exception("Failed to create directory \"$path\": " . $e->getMessage(), $e->getCode(), $e);
            }
        }
        try {
            return chmod($path, $mode);
        } catch (\Exception $e) {
            throw new \aabc\base\Exception("Failed to change permissions for directory \"$path\": " . $e->getMessage(), $e->getCode(), $e);
        }
    }
